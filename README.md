...
# demo_automation git init git add README.md git commit -m first commit git remote add origin https://github.com/fixco/demo_automation.git git push -u origin master
# demo_automation
